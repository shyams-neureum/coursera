...
## Function: Plot2
##
## Description: This function answers question #2: "Have total emissions from 
## PM2.5 decreased in the Baltimore City, Maryland (fips == "24510") from 1999 
...
Plot2 <- function()
{
    ...
    png("Plot2.png", width=1000, height=500)
    ...
    barplot(
        ...
        main="Average Emissions by Year (Baltimore)",
        xlab="Year",
    ...
    barplot(
        ...
        main="Median Emissions by Year (Baltimore)",
        xlab="Year",
    ...
    marks_str <- c("0", sprintf("%.2f", max_maxes/2), sprintf("%.2f", max_maxes))
    
    barplot(
        maxes$Max~maxes$Year, 
        main="Maximum Emissions by Year (Baltimore)",
        xlab="Year",
